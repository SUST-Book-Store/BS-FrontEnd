    ...
    <div>
        <el-container  style="height: 700px; border: 1px solid #eee">
            ...
            <el-container>
                ...
                <el-main>
                    <!-- 表单 -->
                    <el-form :inline="true" :model="SearchOrderDto" class="demo-form-inline">
                        <el-form-item label="订单编号">
                            <el-input v-model="SearchOrderDto.no" placeholder="订单编号"></el-input>
                        </el-form-item>
                        <el-form-item label="状态">
                           <el-select v-model="SearchOrderDto.status" placeholder="请选择状态">
                    ...
                    <!-- 表格 -->
                    <el-table ref="multipleTable"  :data="page.orderList" tooltip-effect="dark" border @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="totalPrice" label="价格" width="180"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        Search(){
            request.post("http://127.0.0.1:3000/admin/listOrder",this.SearchOrderDto).then(res => {
        ...
        send()
        {
            ...
            request.post('http://127.0.0.1:3000/admin/orders/send', orderIds) .then(res => {
